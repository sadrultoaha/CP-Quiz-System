...
public class Java extends JFrame {
	...
	public Java() {
		...
		Qpage3 = new JPanel();
		Qpage3.setForeground(SystemColor.textHighlight);
		Qpage3.setBackground(Color.GRAY);
		Qpage3.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(Qpage3);
		Qpage3.setLayout(null);
		...
		Qpage3.add(textField);
		
		lblJavaTest = new JLabel("Java Test");
		lblJavaTest.setHorizontalAlignment(SwingConstants.CENTER);
		lblJavaTest.setForeground(Color.BLACK);
		lblJavaTest.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 20));
		lblJavaTest.setBackground(new Color(154, 205, 50));
		lblJavaTest.setBounds(298, 81, 377, 42);
		Qpage3.add(lblJavaTest);
	         ...
	         String command = e.getActionCommand();  
		         ...
		         else if(command.equals("easy"))
		         {
		        	 AN="easy";
		        	  ...
		        	  list=0;
		        	  ans=-1;
		        	  File="G:\\Code Bucket II\\JavaLearning\\java\\easy.txt";
		        	  File1="G:\\Code Bucket II\\JavaLearning\\java\\easy-op.txt";
		        	  File2="G:\\Code Bucket II\\JavaLearning\\java\\easy-ans.txt";
		        	  dispose();
			          setVisible(true);
			          try
			             {     	   
		         ...
		         else if(command.equals("mid"))
		         {
		        	 AN="mid";
		        	 	  ...
		        	 	  list=0;
		        	 	  ans=-1;
			        	  File="G:\\Code Bucket II\\JavaLearning\\java\\mid.txt";
			        	  File1="G:\\Code Bucket II\\JavaLearning\\java\\mid-op.txt";
			        	  File2="G:\\Code Bucket II\\JavaLearning\\java\\mid-ans.txt";	
			        	  dispose();
				          setVisible(true);
				          try
				             {     	   
		         ...
		         else if(command.equals("hard"))
		         {
		        	 AN="hard";
		        	 	...
		        	 	list=0;
		        	 	ans=-1;
			        	File="G:\\Code Bucket II\\JavaLearning\\java\\hard.txt";
			        	File1="G:\\Code Bucket II\\JavaLearning\\java\\hard-op.txt";
			        	File2="G:\\Code Bucket II\\JavaLearning\\java\\hard-ans.txt";
		        		dispose();
			        	setVisible(true);  
			        	try
			             {     	   
		         ...
		         else if(command.equals("submit"))
		         {
		        	 try
		     		    { 
		     				...
		     				File file= new File (QuizHome.name+"javaAns"+AN+".txt");
		        	 ...
		        	 dispose();
		        	 TestAns ts = new TestAns("javaAns",AN,"java");
		        	 ts.setVisible(true);
		         }
