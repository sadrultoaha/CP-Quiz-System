...
public class Algo extends JFrame {
	...
	public Algo() {
		...
		Qpage5 = new JPanel();
		Qpage5.setForeground(SystemColor.textHighlight);
		Qpage5.setBackground(Color.GRAY);
		Qpage5.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(Qpage5);
		Qpage5.setLayout(null);
		...
		Qpage5.add(btnNewButton_2);
		btnNewButton_2.setActionCommand("hard");
		
		JLabel bg = new JLabel("");
		bg.setIcon(new ImageIcon("JavaLearning\\BG.jpg"));
		...
		Qpage5.add(textField);
		
		lblNewLabel = new JLabel("Algorithm Test");
		lblNewLabel.setForeground(new Color(0, 0, 0));
		lblNewLabel.setBackground(new Color(154, 205, 50));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 20));
		lblNewLabel.setBounds(298, 74, 377, 42);
		Qpage5.add(lblNewLabel);
	         ...
	         String command = e.getActionCommand();  
		         ...
		         else if(command.equals("easy"))
		         {
		        	 AN="easy";
		        	  ...
		        	  list=0;
		        	  ans=-1;
		        	  File="JavaLearning\\algo\\easy.txt";
		        	  File1="JavaLearning\\algo\\easy-op.txt";
		        	  File2="JavaLearning\\algo\\easy-ans.txt";
		        	  dispose();
			          setVisible(true);
			          try
			             {     	   
		         ...
		         else if(command.equals("mid"))
		         {
		        	 AN="mid";
		        	 	  ...
		        	 	  list=0;
		        	 	  ans=-1;
			        	  File="JavaLearning\\algo\\mid.txt";
			        	  File1="JavaLearning\\algo\\mid-op.txt";
			        	  File2="JavaLearning\\algo\\mid-ans.txt";	
			        	  dispose();
				          setVisible(true);
				          try
				             {     	   
		         ...
		         else if(command.equals("hard"))
		         {
		        	 AN="hard";
		        	 	...
		        	 	list=0;
		        	 	ans=-1;
			        	File="JavaLearning\\algo\\hard.txt";
			        	File1="JavaLearning\\algo\\hard-op.txt";
			        	File2="JavaLearning\\algo\\hard-ans.txt";
		        		dispose();
			        	setVisible(true);  
			        	try
			             {     	   
		         ...
		         else if(command.equals("submit"))
		         {
		        	 try
		     		    { 
		     				...
		     				File file= new File (QuizHome.name+"algoAns"+AN+".txt");
		        	 ...
		        	 dispose();
		        	 TestAns ts = new TestAns("algoAns",AN,"algo");
		        	 ts.setVisible(true);
		         }
